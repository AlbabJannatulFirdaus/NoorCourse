<div data-aos="fade-up" data-aos-duration="1600" class="container-1 d-flex align-items-center justify-content-center">
  <div data-aos="fade-up" data-aos-duration="2000" class="main1 d-flex flex-sm-column flex-lg-row align-items-center justify-content-between">
    <div data-aos="fade-up" data-aos-duration="1800" class="w-100 d-sm-flex d-lg-block flex-sm-column align-items-center justify-content-center">
    ...
    <div class="landingpage-img-1 w-100">
      <img class="w-100" src="<?= base_url('assets/') ?>img/image 17.png" alt="">
    </div>
  </div>
</div>
